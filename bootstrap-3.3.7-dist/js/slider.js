...
function geturl() {
   ...
   childdiv2.appendChild(pic2);
    ...
    pic2.setAttribute("data-target",".bs-example-modal-sm");
    ...
    document.getElementById("modalpic").style.width="400px";
    document.getElementById("modalpic").style.height="400px";
      });
}
